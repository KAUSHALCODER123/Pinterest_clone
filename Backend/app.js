...
// During development we allow all origins to avoid CORS problems when
// the frontend runs on different localhost ports. In production we keep
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    // Allow everything during development for convenience
